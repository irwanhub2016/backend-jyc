            ...
            <div class="card-header">
              ...
              Detail Pengurus</div>
                            ...
                            function panggil_kueri()
                            {
                                ...
                                $queri="select * from tbl_pengurus where no = '$no'"; 
          ...
          <form action="proses_pengurus.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="text" id="firstName" name="nama" class="form-control" placeholder="First name" required="required" autofocus="autofocus" value="<?php echo $nama; ?>" disabled="">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                  <div class="form-label-group">
                    <input type="text" id="firstName" name="no_telp" class="form-control" placeholder="First name" required="required" autofocus="autofocus" value="<?php echo $no_telp; ?>" disabled="">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="text" id="firstName" name="divisi" class="form-control" placeholder="First name" required="required" autofocus="autofocus" value="<?php echo $divisi; ?>" disabled="">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                  <div class="form-label-group">
                    <input type="text" id="firstName" name="jabatan" class="form-control" placeholder="First name" required="required" autofocus="autofocus" value="<?php echo $jabatan; ?>" disabled="">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6">
                  ...
                  <?php $default_state = $status;?>
                      ...
                      <option value='<?php echo $default_state?>' selected='selected'><?php echo $status;?></option>
                       </select>
                  </div>
                </div>
                <div class="col-md-6">
            ...
            <a href="../edit/edit_pengurus.php?no=<?php echo $no; ?>" class="btn btn-info btn-lg">Edit</a>
          </form>
        </div>

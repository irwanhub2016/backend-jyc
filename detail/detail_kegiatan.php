...
//                                            global $y;
        ...
        <div class="card-body">
          <form action="proses_kegiatan.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="text" id="firstName" name="nama_kegiatan" class="form-control" placeholder="First name" required="required" autofocus="autofocus" value="<?php echo $nama_kegiatan; ?>" disabled="">
            ...
            <div class="form-group">
              <div class="form-label-group">
                <textarea class="form-control" name="deskripsi_kegiatan" rows="3" placeholder="<?php echo $deskripsi_kegiatan; ?>" disabled=""></textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
